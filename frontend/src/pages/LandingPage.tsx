      ...
      <section className="container py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {[
              { step: 1, title: "Crie Sua Conta", desc: "Cadastre-se com seu email em 2 minutos", icon: "📝" },
              { step: 2, title: "Instale a Extensão", desc: "Adicione ao seu navegador em 1 minuto", icon: "⚡" },
              { step: 3, title: "Comece a Proteger-se", desc: "Bloqueio automático começa imediatamente", icon: "🛡️" }
            ].map((item, idx) => (
              <div key={idx} className="flex gap-6 items-start">
                <div className="flex-shrink-0">
                  <div className="flex items-center justify-center h-16 w-16 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 text-white text-2xl font-bold shadow-lg">
                    {item.step}
                  </div>
                </div>
